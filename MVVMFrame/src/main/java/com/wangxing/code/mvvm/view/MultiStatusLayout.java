...
public class MultiStatusLayout extends FrameLayout {
    ...
    private final int NULL_RESOURCE_ID = getContext().getResources().getIdentifier("content_view", "id", getContext().getPackageName());
    ...
    public MultiStatusLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MultiStatusLayout, defStyleAttr, 0);
        mEmptyViewResId = a.getResourceId(R.styleable.MultiStatusLayout_emptyView, R.layout.empty_view);
        mErrorViewResId = a.getResourceId(R.styleable.MultiStatusLayout_errorView, R.layout.error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.MultiStatusLayout_loadingView, R.layout.loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.MultiStatusLayout_noNetworkView, R.layout.no_network_view);
        mContentViewResId = a.getResourceId(R.styleable.MultiStatusLayout_contentView, NULL_RESOURCE_ID);
        a.recycle();
